...
public abstract class RoutingStrategy {
	 ...
	 */
	public abstract boolean isGoal(Coordinate coordinate);
	...
	class Node implements Comparable<Node> {
		Coordinate coordinate; // the coordinate of the node
		Direction currentOrientation; // the direction that reaches the node
		ArrayList<Coordinate> pathTotheNode = new ArrayList<Coordinate>();
		int g = 0;// the total action cost
		int f = 0;// the total f value where f= g + h
